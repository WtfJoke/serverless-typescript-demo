...
import { LockFile } from 'aws-cdk-lib/aws-lambda-nodejs/lib/package-manager';

/**
 * Properties for a NodejsFunction
 */
export interface BunFunctionProps extends lambda.FunctionOptions {
    /**
